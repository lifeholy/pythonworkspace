...
#캐릭터 불러오기
charactor = pygame.image.load("E:/pythonworkspace/pygame_basic/charactor.png")
...
while running:
    ...
    screen.blit(background, (int(0),int(0))) #x좌표, y좌표에 백그라운드그림을 띄운다
    screen.blit(charactor, (round(charactor_x_pos), round(charactor_y_pos))) 
    screen.blit(enermy, (round(enermy_x_pos), round(enermy_y_pos))) #적그리기
